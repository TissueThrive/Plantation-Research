...
const ImageTable = () => {
  ...
  const handleDelete = async (docId, date) => {
    try {
      ...
      toast.success(`Plants identification record deleted successfully`);
  ...
  const updateDocument = async (docId, updatedData) => {
    try {
      ...
      toast.success(`Plants identification records updated successfully`);
    } catch (error) {
                  ...
                  <TableRow key={index}>
                    ...
                    >
                      <img
                        ...
                        onClick={() =>
                          handleOpen(row.orginalUrl, row.processedUrl)
                        }
                      />
                    </TableCell>
                    <TableCell
                    ...
                    >
                      <Chip
                        ...
                        sx={{
                          bgcolor:
                            row.status === "Healthy" ? "#c9f2de" : "#f2c9cf",
                          color:
                            row.status === "Healthy" ? "#228B22" : "#ed2323",
                        }}
                      />
                    </TableCell>
                    <TableCell
                    ...
                    >
                      <Select
                        value={
                          row.updatedStatus ? row.updatedStatus : row.status
                        }
                      ...
                      <Button
                        ...
                        onClick={() =>
                          updateDocument(row.id, {
                            reason: row.reason,
                            updatedStatus: row.updatedStatus,
                          })
                        }
                      >
                        Update
